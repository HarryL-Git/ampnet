...
class GraphSAINTRandomWalkSampler(GraphSAINTSampler):
    ...
    def __sample_nodes__(self, batch_size):
        ...
        # node_idx: shape [n_random_walks, ~walk_length + 1]
...
"""
batch_size: number of walks to sample per batch
"""
loader = GraphSAINTRandomWalkSampler(all_data, batch_size=BATCH_SIZE, walk_length=WALK_LENGTH,
